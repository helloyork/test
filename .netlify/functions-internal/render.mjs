	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/user/login/_server.ts.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/user/register/_server.js')
			},
			{
				id: "/contact",
				pattern: /^\/contact\/?$/,
			...
			},
			{
				...
				endpoint: () => import('../server/entries/endpoints/test/_server.ts.js')
			},
			{
				id: "/user",
				pattern: /^\/user\/?$/,
			...
			},
			{
				...
				page: null,
				endpoint: () => import('../server/entries/endpoints/user/_slug_/_server.ts.js')
			}
		],
		matchers: async () => {
